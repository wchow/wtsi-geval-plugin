...
=head2 get_all_Attributes
  ...
  Example    : my ($author) = @{ $gene->get_all_Attributes('author') };
               my @daf_attributes = @{ $daf->get_all_Attributes };
  Description: Gets a list of Attributes of this dna_align_feature.
...
#  print STDERR "DUM DI DUM, HERE WE ARE LOOKING SILLY....\n";
